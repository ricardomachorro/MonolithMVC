    ...
    <body>
        ...
        <%
            ...
            if (resultado) {
                ...
                sessionsa.setAttribute("NombreUser", Nom);
                sessionsa.setAttribute("InstitucionUser", Insti);
                sessionsa.setAttribute("EstudiosUser", Estudios);
                sessionsa.setAttribute("EdadUser", Edad);
                sessionsa.setAttribute("PaisUser", pais);
                sessionsa.setAttribute("DireccionUser", direccion);
                sessionsa.setAttribute("CorreoUser", correo);
                sessionsa.setAttribute("PasswordUser", pass ); 
//out.print("CORREO ELECTRONICO CORRECTAMENTE ENVIADO....." + "\n\n" + "<a href='index.jsp'>VOLVER AL INDEX</a>");
        %>
        <form action="Ingreso" method="post" name="alt" id="alt">
