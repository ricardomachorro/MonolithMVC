...
public class ServerCliente {
    ...
    static final String HOST1 = "192.168.0.6"; //Parametro para el servidor de el proyecto de KerberosServer
    static final int PUERTO1 = 3000;
    
    static final String HOST2 = "192.168.0.6";//Parametro para el servidor de el proyecto de PermisosServer
